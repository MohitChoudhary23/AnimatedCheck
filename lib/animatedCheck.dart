...
class AnimatedCheck extends StatefulWidget {
  ...
  AnimatedCheck({required this.progress, required this.size, this.color, this.strokeWidth});
...
class AnimatedPathPainter extends CustomPainter {
  ...
  Path _createAnyPath(Size size) {
    return Path()
      ..moveTo(0.32083 * size.width + 5.0, 0.54167 * size.height + 5.0)
      ..lineTo(0.46667 * size.width, 0.68750 * size.height)
      ..lineTo(0.80000 * size.width - 20.0, 0.35417 * size.height + 20.0);
  }
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var center = Offset(size.width - 105.0, size.height - 85.0);
    ...
    if (animationPercent > 0.0) {
      canvas.drawCircle(center, radius - 57.0, circleBrush);
    }
    ...
    paint.strokeWidth = strokeWidth ?? size.width * 0.08;
